...
def run_simulation(cfg, rank=0):
    ...
    def build_initial_state(cfg):
        ...
        elif cfg.initial_state == "imperfect_Bell_mixed":
    ...
    checkpoint_folder = os.path.join(
        ...
        (
            ...
            f"_lmin={cfg.min_l}_lmax={cfg.max_l}"
    ...
    for i in range(cfg.steps):
        ...
        if rank == 0:
            print(f"finished cycle {i + 1} of {cfg.steps}")
...
def main():
    ...
    for cfg in configs:
        if rank == 0:
            print(
                f"Running config: L={cfg.L}, dissipation={cfg.dissipation}, "
                f"J={cfg.J}, min_l={cfg.min_l}, max_l={cfg.max_l}, "
                f"initial_state={cfg.initial_state}"
            )
