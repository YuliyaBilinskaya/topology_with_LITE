...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--initial-state", choices=["triv_mixed", "Bell_mixed", "imperfect_Bell_mixed", "W_mixed", "cluster_locally_mixed"], default="W_mixed", help="Choice of initial state.")
