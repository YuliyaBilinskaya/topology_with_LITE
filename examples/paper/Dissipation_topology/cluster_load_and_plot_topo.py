...
checkpoint_folder = os.path.join(data_filepath, f"xx_diss={diss_strength}_J={J}_L={L}_lmin={min_l}_lmax={max_l}_init={init}_locally_mixed")


################### Load data ##################

init = 'locally_cluster'
